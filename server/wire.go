...
func initRouter(logger.ILogger, *handlers.InitializeHandler, *handlers.SetLevelHandler, iface.IResource,
	iface.IPrompt, iface.ITool, iface.EventBus, handlers.RequestDecodeFunc) (router.IRouter, error) {
